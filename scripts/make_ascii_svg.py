...
"""
make_ascii_svg.py
Avi Vashishta's exact monochrome ASCII-art SVG generator.
Reads source-prepped.png and outputs avi-ascii.svg with raster cursor typing animation.
"""
...
def main():
    ...
    parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'
                 f'{USERNAME}@github:~$ whoami <tspan fill="{INK}">Bleezbub</tspan></text>')
    parts.append(f'<rect x="{PAD+186}" y="{status_y-12:.1f}" width="8" height="14" fill="{INK}">'
