...
Avi Vashishta's exact heatmap SVG renderer.
53-week x 7-day grid, diagonal slide-down reveal, Less->More legend,
and two-column stats footer.
...
def main():
    ...
    with open(OUT_PATH, "w", encoding="utf-8") as f:
        f.write(svg)
    print(f"[OK] Wrote {OUT_PATH} ({len(svg)} bytes)")
